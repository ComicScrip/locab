      ...
      <div className={styles.mainContainer}>
        ...
        <section>
          ...
          <div className={styles.polaroidContainer}>
            ...
            <p>
              “Moi, Débora, je suis brésilienne. J’ai quitté mon pays à l’âge de
              24 ans pour découvrir le monde, découvrir une nouvelle langue et
              une nouvelle culture. Et c’est à Dublin que j’ai posé mes valises
              (sans savoir que ce voyage allait changer ma vie). C’est là-bas,
              le jour même de mon arrivée, que je rencontrais Antoine, mon futur
              mari et le papa de mes merveilleux enfants. “
            </p>
          </div>
          <div className={styles.polaroidContainer}>
            <Image
            ...
            <p>
              ...
              Ensemble, nous avons passé 2 années en Irlande, 4 ans au Brésil et
              en 2011 nous sommes arrivés avec nos valises en France, plus
              précisément à Lyon.“
            </p>
          </div>
          <div className={styles.polaroidContainer}>
        ...
        <section>
          ...
          <p>
            Loca-b est un service de location de matériel de puériculture clé en
            main. Nous nous occupons de toute la logistique (livraison,
          ...
          <p>
            ...
            légers, c’est une réalité ! Une vie plus simple et plus responsable
            pour les parents, une charge mentale moins importante pour le départ
            en vacances, c’est ce qui nous anime pour développer ce joli projet
            et vous le proposer. On vous l’assure, c’est plus simple que vous ne
            le croyez !{" "}
          </p>

          <p>
            Nous travaillons avec du matériel de qualité, connu et reconnu des
            parents, et aujourd’hui nous proposons de nombreux équipements comme
            les poussettes YOYO, lit à barreaux, siège-auto ou encore chaise
            haute que vous pouvez retrouver sur notre site.
          </p>
          <button type="button">Je réserve</button>
          <div className={styles.polaroidContainer}>
            <Image
        ...
        <section>
          ...
          <article className={styles.destinationsContainer}>
            <div className={styles.pictureDestination}></div>
          </article>
        </section>
      </div>
    </Layout>
