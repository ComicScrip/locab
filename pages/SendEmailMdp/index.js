...
export default function ResetMdp() {
  ...
  return (
    <Layout>
      <Head>
        <title>{t("Modifiezvotremotdepasse")}</title>
      ...
      <main>
            ...
            <div className={styles.containerGlobal}>
              <div className={styles.forms}>
                <form onSubmit={handleSubmit}>
                  <label htmlFor="emailreset" className={styles.label}>{t("Entrezunemail")}</label>
                  <input
                    type="email"
                    name="emailreset"
                    id="emailreset"
        ...
        {showResultMessage && (
          <div className={styles.divMessage}>
            ...
            <p className={styles.paragraphe1}>{t("p1")}
            </p>
            <div className={styles.email}>{email}</div>
            <p className={styles.paragraphe1}>{t("Sivousnevoyezpasl'email,vérifiezdansvosspams")}</p>
            <button
