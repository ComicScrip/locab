...
export default function ResetPasswordPage() {
  ...
  return (
    <Layout pageTitle={'resetPassword'}>
      <Head>
        <title>{t("Modifier son mot de passe")}</title>
        <meta
      ...
      <main>
        ...
        <h4 className={styles.title}> {t("Modifier son mot de passe")}</h4>
        <div className={styles.containerGlobal}>
          <div className={styles.forms}>
            <form onSubmit={resetPassword}>
              <div>
                <label className={styles.label}> {t("Nouveau mot de passe")}</label>
